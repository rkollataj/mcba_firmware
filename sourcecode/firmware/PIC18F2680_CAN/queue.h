...
#define dSIZE_OF_SPI_MSG 19u
#define dNUMBER_OF_SPI_MSGS 20
#define dMAX_SPI_MESSAGE_SIZE 21
#define dMAX_SPI_PACKET_SIZE 62u
#define dSPI_SIZE_BUFFER 5
...
//unsigned char spiTransmitandReceiveMsg(unsigned char *data);
